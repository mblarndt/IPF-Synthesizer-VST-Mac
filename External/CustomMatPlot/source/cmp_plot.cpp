...
static auto getLimOffset(const float min, const float max, const Scaling scaling) {
  auto new_min = min;
...
static auto jassetLogLimBelowZero(const Scaling scaling, const Lim<float> lim) {
